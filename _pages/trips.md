...
last_modified_at: 2026-09-20 20:45:00 +0800

title: 按照单次出游组织的行程，攻略、指南、和游记的合集
title_display: 旅行合集
tagline: 需要旅行的灵感？
description: 这里是我们历次旅行的时间线。从这里出发，可以找到属于每一次旅行的行程，攻略、指南、和游记。
...
{% else %}
  ...
  {% assign items = site.trips | reverse | where_exp: "item", "item.date <= current_time" %}
{% endif %}
