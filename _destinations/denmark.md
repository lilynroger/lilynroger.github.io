...
permalink: /destinations/denmark/

# jekyll-seo-tag
# see https://github.com/jekyll/jekyll-seo-tag/blob/master/docs/advanced-usage.md
canonical_url: https://lilyroger.com/destinations/denmark/
...
北欧的丹麦，从童话氛围浓郁的首都哥本哈根（Copenhagen），到“童话之父”安徒生的故乡奥登斯（Odense），再到北大西洋最后的秘境法罗群岛（Faroe Islands）。
