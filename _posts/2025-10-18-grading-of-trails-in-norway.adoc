...
:page-last_modified_at: 2025-11-26 08:00:00 +0800
...
在挪威, 徒步步道使用统一的步道分级系统 (Grading of Trails), 以便帮助徒步旅行者们了解步道和路线的难度, 并更好的计划徒步旅行. 这套系统基于国际上普遍采用的 4 级难度等级, 分别用绿色, 蓝色, 红色和黑色标识, 对应于简单 (Easy), 中等 (Moderate), 困难 (Demanding) 和专业 (Expert).
