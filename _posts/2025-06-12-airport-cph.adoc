...
:page-last_modified_at: 2025-06-12 08:00:00 +0800
:page-layout: post
...
TIP: 空侧旅客大厅 (Airside Passenger Concourse) 指的是指机场内经过安检后的区域, 包括登机口, 候机区, 免税店, 贵宾休息室, 海关区域等等. 与空侧相对的是陆侧 (Landside), 安检和边检前的区域, 比如值机, 接机, 商业等等.
